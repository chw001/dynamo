...
<span><b>Workload</b> 8K ISL / 1K OSL chat trace, ~70% design reuse (~8.8% achieved)</span>
</div>
</div>
...
Trace replay with AIPerf against the Mooncake 8K/1K chat trace (designed for ~70% prefix reuse; ~8.8% achieved on this topology). See [`perf/README.md`](https://github.com/ai-dynamo/dynamo/blob/main/recipes/k-exaone-2.0/perf/README.md) for staging the trace, running a concurrency sweep, and fetching artifacts.
